...
- Example: you hit an API rate limit → you then look into API → find a businessman batch endpoint that would fix → rewrite script to accommodate → test → update directive.
